...
public interface AuthenticationStrategy {/**
     * Start auth. Return some token/response which caller uses to continue flow.
     * For simple username/password flow, this can directly return a username or token
