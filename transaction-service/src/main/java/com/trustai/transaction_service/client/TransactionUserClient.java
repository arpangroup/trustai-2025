/*
package com.trustai.transaction_service.client;
...
@ConditionalOnProperty(name = "feign.client.enabled.transaction", havingValue = "true", matchIfMissing = false)
public interface TransactionUserClient extends UserApi {
}
*/
